...
from messages import HealthMessage, OrderMessage, ResponseMessage  # our custom message in native format
...
def driver (name, iters, vec_len):
    ...
    cm = HealthMessage()   # create this once and reuse it for send/receive

    print ("-----contents of message before serializing ----------")
    print(cm)
