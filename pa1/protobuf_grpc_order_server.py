    ...
    def method(self, request, context):
        ...
        try:
            ...
            resp = spb.Response(code=spb.ResponseStatus.OK,
                                    contents="Order Placed")  # allocate the response object. Note it is empty
...
def parseCmdLineArgs():
    ...
    parser.add_argument("-p", "--port", type=int, default=5578,
                        help="Port where the server part of the peer listens and client side connects to (default: 5578)")
